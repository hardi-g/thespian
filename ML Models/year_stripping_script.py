...
if __name__ == "__main__":
    ...
    movies_csv_filename = 'ml-latest-small/ml-latest-small/movies.csv'  # Adjust filename as needed
    ...
    movies_csv_filename = 'ml-latest-small/ml-latest-small/movies1.csv'
